function solve(input) {
    ...
    plantsObjValues.forEach((obj) => {
        const sum = obj.ratings.reduce((sum, el) => sum + el, 0)
        const average = sum / (obj.ratings.length || 1)
        obj.ratings = average;
    });

    let entriesArr = Object.entries(plantsObjValues);
